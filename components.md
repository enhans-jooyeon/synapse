...
1. **§24's refine-prompt has no trigger.** The `edit` ghost icon-button at the input's top-right was removed, so the whole affordance — closed preset menu, reviewable rewrite, Undo Toast — is unreachable until it gets a new entry point. **Open.**
